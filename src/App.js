      ...
      <Row>
        ...
        {winMessage ? (
          <div  className="mb-2 mt-2">
            <h1 className="text-success text-uppercase text-center mb-3">
              {winMessage} 
            </h1>
            <Button onClick={reloadGame} color="success" block className="mb-4">Reload Game</Button>
          </div>
        ) : (
          ...
          <div className="grid">
            {itemArray.map((item, index) => (
              <Card onClick={() => changeItem(index) } color="info">
